...
public:
	...
	Walls(glm::mat4 M,  ShaderProgram* sp,GLuint tex,float roomWidth,float roomHeight)
	{
		...
		this->translates = { glm::vec3(roomWidth/2.0f-doorWidth,roomHeight/2.0f-2.0f,0.0f),
			vec3(-roomWidth/2.0f+doorWidth,roomHeight/2.0f-2.0f,0.0f),
			vec3(0.0f,roomHeight/2.0f -2.0f,roomWidth/2.0f-doorWidth),
			vec3(0.0f,roomHeight/2.0f-2.0f,-roomWidth/2.0f+doorWidth),
			vec3(roomWidth-doorWidth/4.0f,roomHeight-2.0f- (roomHeight-doorHeight)/2.0f,0.0f),
