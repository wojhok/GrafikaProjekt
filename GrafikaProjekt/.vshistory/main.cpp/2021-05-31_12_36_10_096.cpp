...
int main()
{
	...
	std::vector<Model> paintings = { Model("fbxPainting.fbx",0.1f,texPainting,room.matricies[2],sp,glm::vec3(0.0f,0.0f,room.roomWidth/2.0),180.0f, glm::vec3(0.0f,1.0f,0.0f))
