...
public:
	...
	Walls(glm::mat4 M,  ShaderProgram* sp,GLuint tex,float roomWidth,float roomHeight)
	{
		...
		this->translates = { glm::vec3((wallWidth+1.0f)/2.0f,roomHeight/2.0f-2.0f,0.0f),
			vec3(-(wallWidth+1.0f)/2.0f,roomHeight/2.0f-2.0f,0.0f),
			vec3(0.0f,roomHeight/2.0f -2.0f,(wallWidth+1.0f)/2.0f),
			vec3(0.0f,roomHeight/2.0f-2.0f,-(wallWidth+1.0f)/2.0f),
			vec3(roomWidth-doorWidth/2.0f,(doorHeight - 2.0f) + (roomHeight - doorHeight) / 2.0f,0.0f),
			vec3(-roomWidth+doorWidth/2.0f,(doorHeight - 2.0f) + (roomHeight - doorHeight) / 2.0f,0.0f),
			vec3(0.0f,(doorHeight - 2.0f) + (roomHeight - doorHeight) / 2.0f,roomWidth - doorWidth / 2.0f),
			vec3(0.0f,(doorHeight - 2.0f) + (roomHeight - doorHeight) / 2.0f,-roomWidth + doorWidth / 2.0f)
		};
		this->scales = {
			vec3((wallWidth-1.0f)/2.0f,roomHeight / 2.0f,1.0f),
			vec3((wallWidth-1.0f)/ 2.0f,roomHeight / 2.0f,1.0f),
			vec3(1.0f,roomHeight / 2.0f,(wallWidth-1.0f) / 2.0f),
			vec3(1.0f,roomHeight / 2.0f,(wallWidth-1.0f)/ 2.0f),
			vec3((roomWidth-wallWidth)/2.0f,1.0f,1.0f),
			vec3((roomWidth - wallWidth) / 2.0f,1.0f,1.0f),
